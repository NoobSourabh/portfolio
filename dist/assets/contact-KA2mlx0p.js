import{p as o}from"./transition-BEr7z5Ry.js";document.addEventListener("DOMContentLoaded",()=>{if(!document.querySelector(".page.contact-page"))return;const y=document.querySelector(".logo a");y&&(y.textContent=o.personal.initials);const b=document.querySelector(".contact-card-header-main");b&&(b.innerHTML=`
